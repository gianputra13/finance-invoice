...
class App_items_table extends App_items_table_template
{
    ...
    public function items()
    {
        ...
        foreach ($this->items as $item) {
            ...
            $itemHTML .= '<td align="right" width="18%">' . $rate . '</td>';
            ...
            $itemHTML .= '<td class="amount" align="right" width="25%">' . $item_amount_with_quantity . '</td>';
    ...
    public function pdf_headings()
    {
        ...
        $tblhtml .= '<th width="18%" align="right">' . $this->rate_heading() . '</th>';

        // if ($this->show_tax_per_item()) {
        //     $tblhtml .= '<th width="' . $regularItemWidth . '%" align="right">' . $this->tax_heading() . '</th>';
        // }

        $tblhtml .= '<th width="25%" align="right">' . $this->amount_heading() . '</th>';
        $tblhtml .= '</tr>';
